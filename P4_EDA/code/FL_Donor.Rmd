...
author: "Jason Carter"
date: "3 Janaury 2018"
knit: (function(inputFile, encoding) { out_dir <- '../docs'; rmarkdown::render(inputFile, encoding=encoding,output_file=file.path(dirname(inputFile), out_dir, 'P4_EDA.html')) })
output: 
  html_document: 
